...
2. The maintainer clicks **Enable Auto Merge**, *or* a reviewer with write access submits an **Approve** review. The action enters polling mode and watches every other check on the PR.
